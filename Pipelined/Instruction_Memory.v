...
module instr_mem (input [5:0] A, input clk, rst,output [31:0] RD);
   ...
   xpm_memory_spram #(
      ...
      .MEMORY_INIT_FILE("code.mem"),     // String
   ...
   xpm_memory_spram_inst (
      ...
      .douta(RD),                   // READ_DATA_WIDTH_A-bit output: Data output for port A read operations.
